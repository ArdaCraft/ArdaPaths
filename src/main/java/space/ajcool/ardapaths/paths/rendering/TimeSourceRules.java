...
final class TimeSourceRules {
    ...
    /**
     * Tolerance for comparing squared trail distances.
     */
     ...
     * @param nearestTrailDistanceSquared squared distance from the player to the nearest trail element
     * @return true when the segment is tied with or closer than the nearest trail element
     */
    static boolean isNearestTrailElement(double candidateDistanceSquared, double nearestTrailDistanceSquared) {
        return candidateDistanceSquared <= nearestTrailDistanceSquared + EPSILON;
    }
