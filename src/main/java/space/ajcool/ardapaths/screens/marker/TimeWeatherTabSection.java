...
public class TimeWeatherTabSection implements MarkerEditorTab {
    ...
    /**
     * Builds the activation dropdown label for a time activation mode.
     *
     * @param activation      activation mode to display
     * @param activationRange marker activation range shown for marker-range mode
     * @return localized activation label
     */
