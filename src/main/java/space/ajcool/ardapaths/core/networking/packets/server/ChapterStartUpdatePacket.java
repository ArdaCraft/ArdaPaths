...
public record ChapterStartUpdatePacket(String pathId, String chapterId, BlockPos position) implements IPacket {
     ...
     */
    public static final Identifier CHANNEL = ModConstants.modId("path_chapter_start_update");
     ...
     */
    @Override
    public CustomPacketPayload.@NotNull Type<ChapterStartUpdatePacket> type() {
        return TYPE;
    }
