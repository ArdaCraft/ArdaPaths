 ...
 */
public record MarkerTimeSpreadPacket(UUID requestId, long sourcePackedPos, long targetPackedPos, long sourceTime,
                                     long targetTime, String pathId, String chapterId,
                                     boolean clear) implements IRespondablePacket<MarkerTimeSpreadPacket> {

    /**
     * Network channel used for marker time-spread requests.
     */
    public static final Identifier CHANNEL = ModConstants.modId("marker_time_spread");
