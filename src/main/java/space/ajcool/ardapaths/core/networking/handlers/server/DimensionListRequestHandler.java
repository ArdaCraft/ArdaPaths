...
public class DimensionListRequestHandler extends RespondablePacketHandler<EmptyPacket, DimensionListResponsePacket> {
    ...
    public DimensionListRequestHandler() {
        super(EmptyPacket.DIMENSION_LIST_REQUEST_TYPE, EmptyPacket.reader(EmptyPacket.DIMENSION_LIST_REQUEST_TYPE),
                DimensionListResponsePacket.TYPE, DimensionListResponsePacket::read);
    }
     ...
     */
    @Override
    public DimensionListResponsePacket handle(MinecraftServer server, ServerPlayer player, ServerGamePacketListenerImpl handler,
                                              EmptyPacket packet, PacketSender sender) {
