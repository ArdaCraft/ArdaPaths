 ...
 * @param targetMarkerDimension dimension identifier for a cross-dimension chain continuation, or null for legacy backups
 * @param targetMarker        target marker coordinates as {@code x y z} text, or null for legacy backups
