 ...
 */
public record ChapterMarkerEntry(long packedPos, String dimensionId, long timeOfDay, int weather, String proximityMessage,
                                 boolean hasMiscData, boolean chapterStart, boolean chainBreak, boolean dimensionBreak) {
