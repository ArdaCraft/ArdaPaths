...
class MarkerTimeChainTest {
    ...
    /**
     * Verifies the A-F reference chain selects no time before B, interpolates B-D, holds through E, and ramps at F.
     */
    ...
    /**
     * Creates a marker block position on the horizontal test plane.
     *
     * @param x x coordinate
    ...
    /**
     * Creates a player position at a marker center on the horizontal test plane.
     *
     * @param x x coordinate
     * @param z z coordinate
     * @return precise player position
     ...
     * @param nextId          next node ID
     */
    private record Node(BlockPos position, long timeOfDay, TimeActivation activation, int activationRange,
                        String nextId) {
